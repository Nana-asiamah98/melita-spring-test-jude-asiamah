...
@Api(value = "Order Service", description = "A List Of REST Endpoint For Order Service")
public class OrderRestController {
    ...
    @ApiOperation(value = "Fetch Paginated Orders")
    ...
    @ResponseBody
    @ApiOperation(value = "Search an order using order number")
