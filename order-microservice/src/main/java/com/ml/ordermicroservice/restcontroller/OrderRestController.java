...
public class OrderRestController {
    ...
    public ResponseEntity<OrderDTO> acceptAnOrder(@RequestBody OrderDTO orderDTO) throws JsonProcessingException {
    ...
    public ResponseEntity<UpdateOrderStatusDTO> updateOrderStatus(
